...
- **保留私人帳號（目前採用）**：已加入「今天的回覆備忘」，使用者自己勾記收到問候的親友或聊天室暱稱，查看待回覆對象，再到 LINE 自己選人送出，回來手動勾記已回覆。當日紀錄會隨本地日期換日重新開始，不會自動偵測或預選 LINE 收件者。手動提供截圖／匯出內容做辨識仍只是可研究方向，尚未實作，也不會因此取得聊天室 ID。
